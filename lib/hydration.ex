  ...
  defmodule ValueFlows.Hydration do
    ...
    def hydrate() do
      ...
      %{
        ...
        event_or_commitment: [
          resolve_type:
            &ValueFlows.Planning.Satisfaction.GraphQL.event_or_commitment_resolve_type/2
        ],
        person: agent_fields,
        ...
        economic_event: %{
          ...
          resource_inventoried_as: [
            resolve: &ValueFlows.EconomicEvent.GraphQL.fetch_resource_inventoried_as_edge/3
          ],
          to_resource_inventoried_as: [
            resolve: &ValueFlows.EconomicEvent.GraphQL.fetch_to_resource_inventoried_as_edge/3
          ],
          resource_classified_as: [
            resolve: &fetch_classifications_edge/3
          ],
        ...
        economic_resource: %{
          ...
          primary_accountable: [
            resolve: &ValueFlows.EconomicResource.GraphQL.fetch_primary_accountable_edge/3
          ],
          unit_of_effort: [
    ...
    # fallback
    def resolve_context_type(_, _), do: :person
    ...
    # fallback
    def resolve_context_type(_, _), do: :organization

    def production_flow_item_resolve_type(%ValueFlows.EconomicEvent{}, _),
      do: :economic_event

    def production_flow_item_resolve_type(%ValueFlows.EconomicResource{}, _),
      do: :economic_resource

    def production_flow_item_resolve_type(%ValueFlows.Process{}, _),
      do: :process
